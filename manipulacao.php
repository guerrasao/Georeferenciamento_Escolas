...
/**
 * Código padrão utilizado para projetos não OO, com modificações quando necessário ao projeto.
 * Created by PhpStorm.
 * User: Patrick Guerra
 * Date: 29/11/2017
 * Time: 02:42
...
/**
 * function abrirConexao abre uma conexão mysql e retorna-a.
 */
function abrirConexao(){
    $c = new Conexao();
    $con = mysqli_connect($c->host, $c->user, $c->pwd, $c->dbName);
...
/**
 * function fecharConexao recebe a conexão mysql e apenas fecha-a.
 * @param $con
 */
